<nav
    class="navbar navbar-expand-sm my-2 mx-2 rounded-4 border border-light navbar-dark bg-dark bg-opacity-25 shadow-sm">
            ...
            <div class="modal-body pb-2 px-2 gap-2 d-flex flex-column">
                <ul class="list-group">
                    ...
                    <li class="list-group-item p-0 rounded-bottom-4">
                        <a class="nav-link btn btn-sidebar m-0 py-2 rounded-bottom-4 fw-light d-flex align-items-center justify-content-center gap-2"
