...
<body class="bg-official text-light">
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="row mb-2">
                                        ...
                                        <div class="col-lg-6 mb-2 ps-0 d-flex justify-content-evenly">
                                            <div class="d-flex flex-column">
                                                ...
                                                <input type="number" maxlength="4" id="add-amountUsed"
                                                    name="add-amountUsed[]" class="form-control amt-used-input form-add me-3"
                                        ...
                                        <p class="alert alert-warning py-1 mt-1 w-50 mx-auto text-center" id='amt-used-alert' style="display: none;"></p>
                                    </div>
    ...
    <script>
        ...
        $('#addModal').on('click', '#addMoreChem', async function() {
        ...
        $(document).on('change', "#add-status", function() {
            ...
            $('#addMoreChem').attr('data-status', sts);
        ...
        $(document).on('change', '#add-status, #edit-status', function() {
            ...
            if (sel.val() === 'Voided') {
                ...
                $("#amt-used-alert").fadeOut().fadeIn(750).html('Note. Only put the amount the technician used.');
