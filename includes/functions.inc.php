...
function delete_branch($conn, $ids)
{
    ...
    try {
        ...
        if ($error_code === 1451) {
            $message = "Cannot delete the branch with ID $current_id because it’s still linked to one or more branch admins or related records. Please remove the related records first.";
        }
