<aside class="my-2 rounded-end-3 mx-0 sa-sidebar col-sm-2 d-flex flex-column shadow bg-light bg-opacity-25"
    ...
    <div class="mt-2 d-flex" id="sidenav_header">
        ...
        <!-- <button type="button"
            class="btn btn-sidebar me-2 align-middle my-auto d-none border py-4 border-light bg-dark bg-opacity-50"
            id="close_sidebar"><i class="bi bi-caret-left text-light"></i></button> -->
