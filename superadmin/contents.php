...
<body class="bg-official text-light">
    ...
    <div class="sa-bg container-fluid p-0 h-100 d-flex">
        ...
        <!-- main content -->
        <main class="sa-content col-sm-10 p-0 pb-2 container-fluid">
            <!-- navbar -->
            <?php include('navbar.php'); ?>
            <!-- content -->
            <p class="fw-bold text-center text-shadow display-6 bg-light bg-opacity-25 rounded-3 py-3 m-2">Manage
                Contents</p>
            <div class="bg-light bg-opacity-25 mx-0 rounded py-2 px-3 mx-2 my-2">
                <p class="fw-bold fs-2 text-shadow m-0 text-center">Offered Treatments</p>
            ...
            <div class="bg-light bg-opacity-25 mx-0 rounded py-2 px-3 mx-2 my-2">
                <p class="fw-bold m-0 text-center fs-2">Problems</p>
                <hr class="mt-1 mb-2 opacity-50">
                <div class="table-responsive justify-content-center">
                    <form id="problemform">
                        <table class="table align-middle table-bordered table-hover p-2 w-100">
                    ...
                    <p class="text-center alert alert-info w-75 mx-auto" style="display: none;" id="prob_table_alert">
                    </p>
                </div>
            </div>
            <div class="bg-light bg-opacity-25 mx-0 rounded py-2 px-3 mx-2 my-2">
                <div class="table-responsive justify-content-center">
                    <p class="fw-bold fs-2 m-0 text-center">Branches</p>
                    <hr class="mt-1 mb-2 opacity-50">
                    ...
                    <p class="text-center alert alert-info w-75 mx-auto" style="display: none;" id="branch_table_alert">
                    </p>
                </div>
            </div>
            <div class="bg-light bg-opacity-25 mx-0 rounded py-2 px-3 mx-2 mt-2">
                <div class="table-responsive justify-content-center">
                    <p class="fw-bold fs-2 m-0 text-center">Packages</p>
                    <hr class="mt-1 mb-2 opacity-50">
                    <form id="packagesform">
                        <table class="table align-middle table-bordered table-hover p-2 w-100">
                            <thead>
                                <tr class="text-center fs-4 fw-bold">
                                    <th scope="col">
                                        <input type="checkbox" id="checkallpackage" class="form-check-input">
                                    </th>
        ...
        <form id="package_add_form">
            <div class="modal-lg modal fade text-dark modal-edit" data-bs-backdrop="static" id="package_add_modal"
                tabindex="0">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header bg-modal-title text-light">
        ...
        <form id="package_edit_form">
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="row mb-2">
                                <div class="col-6">
                                    <label for="edit_package_name" class="form-label fw-light fs-5">Package
                                        Name:</label>
                                    <input type="text" id="edit_package_name" name="name" class="form-control"
                                        autocomplete="one-time-code">
                                </div>
                                <div class="col-3">
                                    <label for="edit_package_session" class="form-label fw-light fs-5">Session
                                        Count:</label>
                                    <div class="d-flex align-items-center">
                                        <input type="number" id="edit_package_session" name="session"
                                            class="w-25 form-control" autocomplete="one-time-code">
                                        <p class="ms-3 mb-0">Session/s</p>
                                    </div>
                                </div>
                                <div class="col-3">
                                    <label for="edit_package_warranty" class="form-label fw-light fs-5">Warranty
                                        Count:</label>
                                    <div class="d-flex align-items-center">
                                        <input type="number" id="edit_package_warranty" name="warranty"
                                            class="w-25 form-control" autocomplete="one-time-code">
                                        <p class="ms-3 mb-0">Year/s</p>
                                    </div>
                                </div>
                            ...
                            <div class="row mb-2">
                                <div class="col-6">
                                    <label for="edit_package_branch" class="form-label fw-light fs-5">Branch:</label>
                                    <select name="branch" id="edit_package_branch" class="form-select">
                                    </select>
                                </div>
                                <div class="col-6">
                                    <label for="edit_package_trt" class="form-label fw-light fs-5">Package
                                        Treatment:</label>
                                    <select name="treatment" id="edit_package_trt" class="form-select">
                                    </select>
                                </div>
                            </div>
                        </div>
            ...
            <div class="modal fade text-dark modal-edit" data-bs-backdrop="static" id="package_edit_conf_modal"
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header bg-modal-title text-light">
                            <h1 class="modal-title fs-5">Update Package Confirmation</h1>
                            <button type="button" class="btn ms-auto p-0" data-bs-dismiss="modal" aria-label="Close"><i
                                    class="bi bi-x text-light"></i></button>
                        </div>
                        <div class="modal-body">
        ...
        $("#packages").on('click', '.package-edit', async function () {
            ...
            $.get(dataurl, {
                ...
                .done(async function (data) {
                    ...
                    let d = JSON.parse(data);
                    // console.log(d);
                    $("#package_edit_id_input").val(d.id);
                    $("#edit_package_name").val(d.name);
                    $("#edit_package_session").val(d.session_count);
