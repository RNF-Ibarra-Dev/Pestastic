    ...
    <div class="sa-bg container-fluid p-0 h-100 d-flex">
        ...
        <main class="sa-content col-sm-10 p-0 container-fluid">
            ...
            <div
                ...
                <form class="row g-2 text-light" action="../includes/createosaccount.inc.php" method="post">
                    <div class="container my-3">

                        <h1 class="h3 fw-normal text-center"><img src="../img/pestasticlogoonly.png" alt width="30"
                                height="30" class="me-3">Create Operation Supervisor Account</h1>
                    </div>
                    ...
                    <div class="form-floating col-md-8 form-custom mb-2">
                    ...
                    <button class="btn btn-form-submit bg-light bg-opacity-75 text-dark" type="submit"
                        name="submitCreateAcc"><i class="bi bi-person-add me-2"></i>Create Account</button>
                    ...
                    if (isset($_GET["error"])) {
                        if ($_GET["error"] == "emptyinput") {
                            ...
                            echo "<p class='text-center alert alert-info w-75 mx-auto'>Account created.</p>";
