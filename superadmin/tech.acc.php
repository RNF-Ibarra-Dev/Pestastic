        ...
        <main class="sa-content col-sm-10 p-0 container-fluid">
                                        ...
                                        <td>
                                            <div class="d-flex justify-content-center">
                                                <button type="button" class="btn btn-sidebar me-2" data-bs-toggle="modal"
                                                    data-bs-target="#editModal<?= $techId ?>"><i
                                                        class="bi bi-person-gear me-1"></i>edit</button>
                                                <button type="button" class="btn btn-sidebar me-2" data-bs-toggle="modal"
                                                    data-bs-target="#deleteModal<?= $techId ?>"><i
                                                        class="bi bi-person-dash me-1"></i>delete</button>
                                            </div>
                                        </td>
                                    </tr>
                                    <!-- edit modal -->
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <div class="row mb-2">
                                                            ...
                                                            <div class="col-lg-8 mb-2">
                                                                ...
                                                                <input type="email" name="email" class="form-control"
                                                                    id="email<?= $techId ?>" value="<?= $techEmail ?>" required>
                                                        ...
                                                        <div class="row mb-2">
                                                            <div class="col-lg-4 mb-2">
                                                                <label for="contact-number<?= $techId ?>"
                                                                    class="form-label fw-light">Contact
                                                                    Number</label>
                                                                <input type="text" name="contactNo" class="form-control"
                                                                    id="contact-number<?= $techId ?>" value="<?= $techContact ?>"
                                                                    required>
                                                            </div>

                                                            <div class="col-lg-4 mb-2">
                                                                <label for="emp-id<?= $techId ?>"
                                                                    class="form-label fw-light">Employee ID</label>
                                                                <input type="number" name="empId" class="form-control"
                                                                    id="emp-id<?= $techId ?>" value="<?= $techEmpId ?>" required>
                                                            </div>
                                                            ...
                                                            <div class="col-lg-4 mb-2">
                                                                ...
                                                                <input type="date" name="birthdate" class="form-control"
                                                                    id="emp-id<?= $techId ?>" value="<?= $techBirthdate ?>"
                                                                    required>
                                                            </div>
                                                        </div>
                                                        <div class="mb-2 col">
                                                            <label for="address<?= $techId ?>"
                                                                class="form-label fw-light">Address</label>
                                                            <input type="text" name="address" class="form-control"
                                                                id="address<?= $techId ?>" value="<?= $techAddress ?>" required>
                                                        </div>
                                                        <div class="row mb-2">
                                                            <div class="col-lg-6 mb-2">
                                                                <label for="pass<?= $techId ?>"
                                                    ...
                                                    <div class="modal-footer">
                                                        ...
                                                        <button type="button" class="btn btn-grad"
                                                            data-bs-target="#modalVerify<?= $techId ?>"
            ...
            if (isset($_GET["error"])) {
                if ($_GET["error"] == "none") {
                    ...
                    echo "<p class='text-center alert alert-info w-75 mx-auto'>Username or Email already exist, please try again.</p>";
