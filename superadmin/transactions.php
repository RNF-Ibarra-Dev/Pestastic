    ...
    <div class="sa-bg container-fluid p-0 d-flex">
        ...
        <main class="sa-content col-sm-10 p-0 container-fluid" id="transaction_content">
                ...
                <div class="modal fade text-dark modal-edit" data-bs-backdrop="static" id="ir_edit_confirm" tabindex="0"
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <div class="row mb-2">
                                    <label for="ir_modify_pwd" class="form-label fw-light">Modify report? Enter manager
            ...
            <form id="viewEditForm">
                <div class="row g-2 text-dark m-0">
                    <div class="modal modal-xl fade text-dark modal-edit" data-bs-backdrop="static" id="details-modal"
                        tabindex="-1">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-body pb-1">
                                    ...
                                    <p id="transvoidalert"
                                        class="alert alert-danger py-2 text-center w-50 mx-auto mb-0"></p>
                ...
                <div class="modal fade text-dark modal-edit" id="confirmation" data-bs-backdrop="static" tabindex="0"
        ...
        async function view_transaction(transId) {
            try {
                ...
                if (details.success) {
                    ...
                    $('#view-time').html(`Created at: ${d.created_at} by ${d.created_by}<br>Updated at: ${d.updated_at} by ${d.updated_by}<br> Branch: ${d.branch.name}`);
