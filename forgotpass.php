...
<body class="d-flex py-4 bg-body-tertiary bg-official-login">
    ...
    <div
        class="w-25 h-50 d-flex flex-column align-items-center justify-content-center container bg-light bg-opacity-25 rounded-4 shadow-lg">
        <form id="resetpass">
            <div class="px-2 my-auto">
                <h1 class="fs-2 fw-bold text-light">Reset Password</h1>
                <p class="fw-light text-light">Please provide the email of the account.</p>
